...
public abstract class CommonListFragment extends SupportFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    LinearLayout       _mLlCommonNoData;
    @Bind(R.id.iv_common_no_data_img)
    ImageView          _mIvCommonNoDataImg;
    @Bind(R.id.tv_common_no_data_tip)
    TextView           _mTvCommonNoDataTip;
    @Bind(R.id.recy_common_list)
    RecyclerView       _mRecyCommonList;
    @Bind(R.id.srf_common_list)
    SwipeRefreshLayout _mSrfCommonList;
    private SuperAdapter _mAdapter;
