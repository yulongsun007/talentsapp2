...
package win.yulongsun.framework.util.java.util;
...
import win.yulongsun.framework.util.java.lang.IntegerUtils;
...
public class DateTimeUtils {
	 ...
	 * @return 日期格式化器
	 */
	public static DateFormat getDateFormatByDefault(){
	 ...
	 * @return 时间格式化器
	 */
	public static DateFormat getTimeFormatByDefault(){
	 ...
	 * @return 时间格式化器
	 */
	public static DateFormat getTimeFormatByDefault24Hour(){
		return getDateTimeFormatByCustom("HH:mm:ss");
	}
	...
	public static String getCurrentDateByDefultFormat(){
		return getCurrentDateTimeByFormat(getDateFormatByDefault());
	}
	...
	public static String getCurrentTimeByDefultFormat(){
		return getCurrentDateTimeByFormat(getTimeFormatByDefault());
	}
	...
	public static String getCurrentTimeByDefult24HourFormat(){
		return getCurrentDateTimeByFormat(getTimeFormatByDefault24Hour());
	}
