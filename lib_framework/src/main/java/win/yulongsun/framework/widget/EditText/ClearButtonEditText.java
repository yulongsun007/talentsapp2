...
import win.yulongsun.framework.util.ResUtil;
 ...
 */
public class ClearButtonEditText extends EditText implements
    ...
    private void init() {
        ...
        if (mClearDrawable == null) {
            mClearDrawable = getResources().getDrawable(ResUtil.getIdByName(getContext(), "drawable", "ic_btn_clean_black_24dp"));
        }
        //Intrinsic:固有的
