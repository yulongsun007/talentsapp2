package win.yulongsun.framework.widget.Bottom;
...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.color_tab_unselect));
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.color_tab_unselect));
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.color_primary));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.color_primary));
        } else {
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.color_tab_unselect));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.color_tab_unselect));
        }
    }
