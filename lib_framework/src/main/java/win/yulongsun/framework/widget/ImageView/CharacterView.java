package win.yulongsun.framework.widget.ImageView;
...
public class CharacterView extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        if(a.hasValue(R.styleable.CharacterView_cv_title_text)){
            mTitleText = a.getString(R.styleable.CharacterView_cv_title_text);
        }

        mTitleColor = a.getColor(R.styleable.CharacterView_cv_title_color, DEFAULT_TITLE_COLOR);
        mBackgroundColor = a.getColor(R.styleable.CharacterView_cv_background_color, DEFAULT_BACKGROUND_COLOR);

        mBorderWidth = a.getDimensionPixelSize(R.styleable.CharacterView_cv_border_width, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(R.styleable.CharacterView_cv_border_color, DEFAULT_BORDER_COLOR);

        mTitleSize = a.getDimension(R.styleable.CharacterView_cv_title_size, DEFAULT_TITLE_SIZE);
        mLetterCount = a.getInteger(R.styleable.CharacterView_cv_letter_count, DEFAULT_LETTER_COUNT);

        mType = a.getInt(R.styleable.CharacterView_cv_type, TYPE_CIRCLE);
